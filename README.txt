...
galaxy, a kinetic sculpture by Douglas Ruuska and Joshua Krueger, features at
its core a PIC18F452 microcontroller running a pattern generator written in C.
The pattern generator creates a serial broadcast that is received by the LED
drivers to produce the color effects seen across the fiber optic stars of the
galaxy's spiral arms.  This project is that pattern generator.
...
hardware on hand.  I've broken the code into several files.  Here  is a
manifest:
